...
$(document).ready(function() {
    ...
    $.getJSON('template.json', function(json) {
        ...
        if (json[1].data) {
            ...
            hiddenName.value = json[1].game_name;
            hiddenTemplate.value = json[1].game_template;
            hiddenID.value = json[1].game_id;

            // loops through the json template file and retrieves the elements
            for (i = 0; i < json[1].data.length; i++) {
                choiceSelection[i] = new Array;
                choiceSelection[i][0] = json[1].data[i].question;
                choiceSelection[i][1] = json[1].data[i].word1;
                choiceSelection[i][2] = json[1].data[i].image1;
                choiceSelection[i][3] = json[1].data[i].word2;
                choiceSelection[i][4] = json[1].data[i].image2;
                choiceSelection[i][5] = json[1].data[i].word3;
                choiceSelection[i][6] = json[1].data[i].image3;
            }
    ...
    function displayQuestion() {
        ...
        if (rnd == 2) {
            ...
            c2 = choiceSelection[questionNumber][5];
            c3 = choiceSelection[questionNumber][1];
        ...
        if (rnd == 3) {
            c1 = choiceSelection[questionNumber][5];
            c2 = choiceSelection[questionNumber][1];
        ...
        image = new Sprite(choiceSelection[questionNumber][2]);
        image.x = 210;
        image.y = 226;
        image.width = 100;
        image.height = 100;
        ...
        //Stores the image from the template json file and displays it
        image2 = new Sprite(choiceSelection[questionNumber][4]);
        image2.x = 400;
        image2.y = 226;
        image2.width = 100;
        image2.height = 100;
        ...
        //Stores the image from the template json file and displays it
        image3 = new Sprite(choiceSelection[questionNumber][6]);
        image3.x = 600;
        image3.y = 226;
        image3.width = 100;
        image3.height = 100;
        ...
        text = new Text(c1, style2);
        text.position.set(270, 550);
        text.anchor.set(0.5, 0.5);
        app.stage.addChild(text);

        //displays the word2 from the template json file
        text2 = new Text(c2, style2);
        text2.position.set(470, 550);
        text2.anchor.set(0.5, 0.5);
        app.stage.addChild(text2);

        //displays the word3 from the template json file
        text3 = new Text(c3, style2);
        text3.position.set(670, 550);
