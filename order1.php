...
$(document).ready(function() {
    ...
    $.getJSON('template.json', function(json) {
        ...
        if (json[3].data) {
            ...
            hiddenName.value = json[3].game_name;
            hiddenTemplate.value = json[3].game_template;
            hiddenID.value = json[3].game_id;

            // loops through the json template file and retrieves the data
            for (i = 0; i < json[3].data.length; i++) {
              choiceSelection[i] = new Array;
              choiceSelection[i][0] = json[3].data[i].question;
              choiceSelection[i][1] = json[3].data[i].text1;
              choiceSelection[i][2] = json[3].data[i].text2;
              choiceSelection[i][3] = json[3].data[i].image1;
              choiceSelection[i][4] = json[3].data[i].image2;
              choiceSelection[i][5] = json[3].data[i].image3;
            }
