...
$(document).ready(function() {
    ...
    $.getJSON('template.json', function(json) {
        ...
        if (json[2].data) {
            ...
            hiddenName.value = json[2].game_name;
            hiddenTemplate.value = json[2].game_template;
            hiddenID.value = json[2].game_id;

            // loops through the json template file and retrieves the elements
            for (i = 0; i < json[2].data.length; i++) {
                choiceSelection[i] = new Array;
                choiceSelection[i][0] = json[2].data[i].question;
                choiceSelection[i][1] = json[2].data[i].word1;
                choiceSelection[i][2] = json[2].data[i].image1;
                choiceSelection[i][3] = json[2].data[i].word2;
                choiceSelection[i][4] = json[2].data[i].image2;
                choiceSelection[i][5] = json[2].data[i].word3;
                choiceSelection[i][6] = json[2].data[i].image3;
            }
