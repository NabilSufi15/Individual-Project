    ...
    $(document).ready(function() {
        ...
        $.getJSON('template.json', function(json) {
            ...
            if (json[14].data) {
                ...
                hiddenName.value = json[14].game_name;
                hiddenTemplate.value = json[14].game_template;
                hiddenID.value = json[14].game_id;

                // loops through the json template file and retrieves the elements
                for (i = 0; i < json[14].data.length; i++) {
                    choiceSelection[i] = new Array;
                    choiceSelection[i][0] = json[14].data[i].group1Text;
                    choiceSelection[i][1] = json[14].data[i].group1Image1;
                    choiceSelection[i][2] = json[14].data[i].group1Image2;
                    choiceSelection[i][3] = json[14].data[i].group1Image3;
                    choiceSelection[i][4] = json[14].data[i].group2Text;
                    choiceSelection[i][5] = json[14].data[i].group2Image1;
                    choiceSelection[i][6] = json[14].data[i].group2Image2;
                    choiceSelection[i][7] = json[14].data[i].group2Image3;
                }
