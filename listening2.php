    ...
    $(document).ready(function() {
        ...
        $.getJSON('template.json', function(json) {
            ...
            if (json[10].data) {
                ...
                hiddenName.value = json[10].game_name;
                hiddenTemplate.value = json[10].game_template;
                hiddenID.value = json[10].game_id;

                // loops through the json template file and retrieves the elements
                for (i = 0; i < json[10].data.length; i++) {
                  choiceSelection[i] = new Array;
                  choiceSelection[i][0] = json[10].data[i].sound;
                  choiceSelection[i][1] = json[10].data[i].question;
                  choiceSelection[i][2] = json[10].data[i].correctChoice;
                  choiceSelection[i][3] = json[10].data[i].choice1;
                  choiceSelection[i][4] = json[10].data[i].choice2;
                }

                displayQuestion();
                console.log(json[10].data)
            }
