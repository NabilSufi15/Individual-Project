...
$(document).ready(function() {
    ...
    $.getJSON('template.json', function(json) {
        ...
        if (json[0].data) {
            ...
            hiddenName.value = json[0].game_name;
            hiddenTemplate.value = json[0].game_template;
            hiddenID.value = json[0].game_id;

            // loops through the json template file and retrieves the elements
            for (i = 0; i < json[0].data.length; i++) {
                choiceSelection[i] = new Array;
                choiceSelection[i][0] = json[0].data[i].question;
                choiceSelection[i][1] = json[0].data[i].word1;
                choiceSelection[i][2] = json[0].data[i].image1;
                choiceSelection[i][3] = json[0].data[i].word2;
                choiceSelection[i][4] = json[0].data[i].image2;
                choiceSelection[i][5] = json[0].data[i].word3;
                choiceSelection[i][6] = json[0].data[i].image3;
            }
